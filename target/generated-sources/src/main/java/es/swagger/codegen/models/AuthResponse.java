...
public class AuthResponse   {
   ...
   * @return error
   **/
  @Schema(example = "Error interno del servidor.", required = true, description = "")
      @NotNull
   ...
   * @return token
   **/
  @Schema(example = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...", required = true, description = "Token JWT generado para el usuario")
      @NotNull
   ...
   * @return message
   **/
  @Schema(example = "Inicio de sesión exitoso", required = true, description = "")
      @NotNull
  ...
  @Override
  public int hashCode() {
    return Objects.hash(error, token, message);
  }
